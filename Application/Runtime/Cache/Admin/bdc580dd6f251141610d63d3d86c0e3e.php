...
<!-- 	<li class="dropdown">
    ...
    <!-- /.sidebar-collapse -->
 	...
 	<div class="row">
		<form method="get" action="<?php echo U('Business/index');?>">
		<div class="col-md-3">
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php if(is_array($userinfo)): $i = 0; $__LIST__ = $userinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td>
											<button type="button" onclick="location='<?php echo U('business/business',array('uid'=>$vo['id']));?>'" class="btn btn-primary btn-xs">人工办理长租业务</button>
										</td>
