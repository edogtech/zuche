...
<!-- 	<li class="dropdown">
	...
	<div class="row">
		<div class="col-md-12">
		<form method="post" action="<?php echo U('Auth/do_modify_auth_group');?>">
			<div class="panel-body">
				...
				<div class="form-group" style='width:40%'>
                    ...
                    <select class="form-control" name='gid'>
                    	...
                    	<?php if(is_array($data_group)): $i = 0; $__LIST__ = $data_group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php echo $data['group_id']==$vo['id']?'selected':'';;?> ><?php echo ($vo['title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
