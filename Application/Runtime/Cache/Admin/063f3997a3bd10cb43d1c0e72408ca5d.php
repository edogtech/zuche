...
<!-- 	<li class="dropdown">
	...
	<div class="row">
		<form method="get" action="<?php echo U('User/deposit_list');?>">
		<div class="col-md-3">
		...
		<div class="col-md-3">
			<div class="form-group">
				缴纳状态:
				<select style="display:inline;width:70%;" class="form-control" name="deposit">
					<option value="" <?php echo empty($_GET['deposit'])?"selected":'';;?> >全部</option>
					<option value="1" <?php echo $_GET['deposit']=='1'?"selected":'';;?> >已缴纳</option>
					<option value="2" <?php echo $_GET['deposit']=='2'?"selected":'';;?> >退款中</option>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">保证金用户</div>
				<!-- /.panel-heading -->
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php if(is_array($userinfo)): $i = 0; $__LIST__ = $userinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td>
											<?php switch($vo["deposit"]): case "1": ?><span style="color:green;">已缴纳</span><?php break;?>
												<?php case "2": ?><span style="color:orange;">用户申请退款</span><?php break; endswitch;?>
										</td>
										<td>
											<button type="button" data-toggle="modal" data-target="#exampleModal" data-name="<?php echo ($vo['name']); ?>" data-id="<?php echo ($vo['id']); ?>" data-phone="<?php echo ($vo['phone']); ?>" class="btn btn-primary btn-xs">查看审核信息</button>
										</td>
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
		<form method="post" enctype="multipart/form-data" action="<?php echo U('User/checkdeposit');?>">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							 <label>保证金退款金额：</label>
							<input type="text" id="txtMoney "name="money">
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<form style="display:inline;" method="post" action="<?php echo U('User/checkdeposit');?>">
