...
<!-- 	<li class="dropdown">
	...
	<div class="row">
		<div class="col-md-6">
		<form method="post" action="<?php echo U('AdminUser/modifyPwd');?>">
			<div class="panel-body">
				<div class="form-group">
					<label>账号：<?php echo ($_SESSION['admininfo']['nickname']); ?></label>
				</div>
				<div class="form-group">
					<label>原密码：</label>
					<input type="password" id="txtOldPwd" name="txtOldPwd" class="form-control">
				</div>
				<div class="form-group">
					<label>新密码：</label>
				...
				<!--接收session变量用户ID  -->
				<input type="hidden" id="txtID" name="txtID" value="<?php echo ($ID); ?>" class="form-control">
				<br/>
				<div class="form-group">
					<button type="submit" class="btn btn-primary btn-lg btn-block">
						确定
					</button>
					<button type="reset" class="btn btn-outline btn-primary btn-lg btn-block" >
						重置
					</button> 
				</div>
			</div>
