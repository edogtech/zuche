...
<!-- 	<li class="dropdown">
	...
	<div class="row">
		<div class="col-md-8" style="min-height:50px;">
            <button type="button" class="btn btn-primary btn-md" type="button" onclick="location='<?php echo U('Auth/add_group');?>'"  style="position:absolute;right:15px;">添加权限组</button>
        </div>
		<div class="col-md-8">
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td>
											<button type="button" onclick="location='<?php echo U('Auth/do_delete_group',array('id'=>$vo['id']));?>'" class="btn btn-danger btn-xs">删除</button>
											<button type="button" onclick="location='<?php echo U('Auth/modify_group',array('id'=>$vo['id']));?>'" class="btn btn-success btn-xs">修改/查看权限</button>
										</td>
