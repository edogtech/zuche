...
<!-- 	<li class="dropdown">
	...
	<div class="row">
		<div class="col-md-6">
			<form action="<?php echo U('Car/do_add_car');?>" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<label>选择品牌</label>
					<select class="form-control" name="brand_id" id='car_brand'>
				...
				<div class="form-group">
					...
					<select class="form-control" name="station_id">
						<option value=''>--请选择--</option>
						<?php if(is_array($station)): $i = 0; $__LIST__ = $station;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>"><?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				...
				<div class="form-group">
					...
					<p class="help-block">请输入车辆乘坐人数</p>
				</div>
