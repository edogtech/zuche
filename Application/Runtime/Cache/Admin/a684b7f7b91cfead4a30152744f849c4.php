...
<!-- 	<li class="dropdown">
    ...
    <!-- /.sidebar-collapse -->
 	...
 	<div class="row">
		<form method="get" action="<?php echo U('Auth/auth_list');?>">
		<div class="col-md-3">
			<div class="form-group">
				权限注释:
				<input style="display:inline;width:70%;" class="form-control" type="text" name="title" value="<?php echo isset($_GET['title'])?$_GET['title']:'';;?>"></div>
		</div>
		...
		<div class="col-md-3">
			<div class="form-group">
				...
				<button style="margin-left:20px;" type="button" data-toggle="modal" data-target="#exampleModal"  class="btn btn-primary">添加权限</button>
			</div>
		</div>
		</form>
	</div>
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td>
											<button type="button" onclick="location='<?php echo U('Auth/do_delete_auth',array('id'=>$vo['id']));?>'" class="btn btn-danger btn-xs">删除</button>
											<button type="button" onclick="location='<?php echo U('Auth/modify_auth',array('id'=>$vo['id']));?>'" class="btn btn-success btn-xs">修改</button>
										</td>
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<form method="post" action="<?php echo U('Auth/do_add_auth');?>">
				...
				<div class="modal-body">
					...
					<div class="form-group" style="width:80%;" >
						...
						<p class="help-block">控制器/方法(需开发人员按格式正确录入)</p>
					</div>

					<div class="form-group" style="width:80%;" >
						<label>权限注释</label>
						<input class="form-control" type="text" name="title" >
						<p class="help-block">权限的介绍说明</p>
					</div>
