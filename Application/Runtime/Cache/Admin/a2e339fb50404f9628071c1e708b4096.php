...
<!-- 	<li class="dropdown">
	...
	<div class="row">
		<form method="get" action="<?php echo U('RentInfo/index');?>">
	...
	<div class="row">	
		...
		<div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">租车信息列表</div>
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php echo ($vo['brand']); echo ($vo['model']); ?></td>
							...
							<!-- <td align="center">
								<a href="#" data-toggle="modal"  data-target="#checkModal" 
								data-id="<?php echo ($vo['id']); ?>"
								data-number="<?php echo ($vo['order_number']); ?>"	
								data-uname="<?php echo ($vo['name']); ?>"
								data-initiate_time="<?php echo date('Y-m-d H:i:s',$vo['initiate_time']);?>"
								data-suggestion="<?php echo ($vo['suggestion']); ?>"
								data-check_time="<?php echo (date('Y-m-d H:i:m',$_SERVER['REQUEST_TIME'])); ?>"
								data-refund="<?php echo ($vo['refund']); ?>">
