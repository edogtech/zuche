...
<!-- 	<li class="dropdown">
    ...
    <!-- /.sidebar-collapse -->
 	...
 	<div class="row">
		<form method="get" action="<?php echo U('Auth/admin_list');?>">
		<div class="col-md-3">
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td>
											<button type="button" onclick="location='<?php echo U('Auth/modify_auth_group',array('uid'=>$vo['uid'],'name'=>$vo['name']));?>'" class="btn btn-success btn-xs">修改权限组</button>
										</td>
