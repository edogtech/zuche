...
<!-- 	<li class="dropdown">
    ...
    <!-- /.sidebar-collapse -->
 	...
 	<div class="row">
		<form method="get" action="<?php echo U('Business/return_car');?>">
		<div class="col-md-3">
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td>
											<button type="button" onclick="location='<?php echo U('business/do_return_car',array('info_id'=>$vo['id'],'car_id'=>$vo['car_id']));?>'" class="btn btn-primary btn-xs">确认还车</button>
										</td>
