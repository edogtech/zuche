...
<!-- 	<li class="dropdown">
	...
	<div class="row">
		<?php if($photoinfo['pic1']): ?><img  class="img-responsive"  src="/zuche<?php echo ($photoinfo['pic1']); ?>" /><?php endif; ?>

		<?php if($photoinfo['pic2']): ?><img  class="img-responsive"  src="/zuche<?php echo ($photoinfo['pic2']); ?>" /><?php endif; ?>

		<?php if($photoinfo['pic3']): ?><img  class="img-responsive"  src="/zuche<?php echo ($photoinfo['pic3']); ?>" /><?php endif; ?>

		<?php if($photoinfo['pic4']): ?><img  class="img-responsive"  src="/zuche<?php echo ($photoinfo['pic4']); ?>" /><?php endif; ?>
	</div>
