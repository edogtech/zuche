...
<!-- 	<li class="dropdown">
    ...
    <!-- /.sidebar-collapse -->
        ...
        <div class="row">
        <form method="get" action="<?php echo U('Car/station');?>">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="form-group">
                地址:
                <input style="display:inline;width:70%;" class="form-control" type="text" name="address" value="<?php echo isset($_GET['address'])?$_GET['address']:'';;?>"></div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <button type="button" class="btn btn-primary btn-md" onclick="location='<?php echo U('Car/add_station');?>'" >添加站点</button>
            </div>
        </div>
        </form>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">所有站点</div>
                <!-- /.panel-heading -->
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <button type="button" onclick="location='<?php echo U('Car/modify_station',array('id'=>$vo['id']));?>'" class="btn btn-primary btn-xs" >修改</button>
    ...
    <div class="modal fade" id="delete_brand" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <form method="post" action="<?php echo U('Car/del_station');?>">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="exampleModalLabel">删除站点名称</h4>
                    </div>
                    <div class="modal-body">

                        <div class="form-group">
                            <h4 style="text-align:center;color:red;" ><b id="del_brand_name"></b></h4>
                            <p style="color:orange;">请注意，如果您删除了此站点，与其关联的所有车辆型号信息，车辆详细信息将一并删除且数据无法恢复！</p>
                        </div>
