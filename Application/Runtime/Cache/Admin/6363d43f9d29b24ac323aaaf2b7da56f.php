...
<!-- 	<li class="dropdown">
	...
	<div class="row">
		<div class="col-md-6">
			<form action="<?php echo U('Car/do_modify_car');?>" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<label>品牌</label>
					<select class="form-control" name="brand_id">

						<?php if(is_array($brand)): $i = 0; $__LIST__ = $brand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>"  <?php echo $vo['id']==$info['brand_id']?"selected":'';;?>><?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				...
				<div class="form-group">
					...
					<select class="form-control" name="model_id">
						...
						<?php if(is_array($model)): $i = 0; $__LIST__ = $model;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php echo $vo['id']==$info['model_id']?"selected":'';;?> ><?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				...
				<div class="form-group">
					...
					<select class="form-control" name="station_id">
						...
						<?php if(is_array($station)): $i = 0; $__LIST__ = $station;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php echo $vo['id']==$info['station_id']?"selected":'';;?>><?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				...
				<div class="form-group">
					<label>车牌号</label>
					<input class="form-control" name="plate" value="<?php echo ($info['plate']); ?>">
					<p class="help-block">请输入车牌号</p>
				</div>

				<div class="form-group">
					<label>价格</label>
					<input class="form-control" name="price" value="<?php echo ($info['price']); ?>">
					<p class="help-block">请输入车辆出租价格(每小时)</p>
				</div>
