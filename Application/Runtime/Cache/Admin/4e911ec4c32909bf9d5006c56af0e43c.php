...
<!-- 	<li class="dropdown">
	...
	<div class="row">
		<div class="col-md-10" style="min-height:50px;">
			<button type="button" class="btn btn-primary btn-md"  onclick="location='<?php echo U('Car/add_model');?>'" style="position:absolute;right:15px;">添加型号</button>
		</div>
		<div class="col-md-10">
			<div class="panel panel-default">
				<div class="panel-heading">车辆型号列表</div>
				<!-- /.panel-heading -->
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td><img  class="img-responsive"  src="/zuche<?php echo ($vo['img_url']); ?>" style="width:100px;height:70px;margin:0 auto;"/></td>
										<td><?php echo date('Y-m-d',$vo['add_time']);?></td>
										<td>
											<button type="button" onclick="window.location.href='<?php echo U('Car/modify_model',array('id'=>$vo['id']));?>'" class="btn btn-primary btn-xs" >修改</button>
    ...
    <div class="modal fade" id="delete_brand" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <form method="post" action="<?php echo U('Car/del_model');?>">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="exampleModalLabel">删除型号名称</h4>
                    </div>
                    <div class="modal-body">

                        <div class="form-group">
                            <h4 style="text-align:center;color:red;" ><b id="del_brand_name"></b></h4>
                            <p style="color:orange;">请注意，如果您删除了此型号名称，与其关联的所有车辆详细信息将一并删除且数据无法恢复！</p>
                        </div>
